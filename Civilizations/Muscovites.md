...
### A Gunpowder and Defensive civilization
...
### Castle Age: Oprichina
 ...
 - The Oprichina was a political police organization and personal guard of Tsar Ivan IV, intended to target any disloyal nobles within newly conquered territories. This included seizing land, resettling populations and confiscating wealth.
...
## Tech Tree
 ...
 - Barracks:
   ...
   - Missing Halberdier.
     - This is primarily for gameplay considerations, as Muscovy and later Russia did field Halberdiers.
     - If they ended up being weak in late game, giving them Halberdier would be my first choice for a buff, since they currently rely on Hussar, defences and a full economy tree for the late game, which might not be sufficient against a good Halberdier civ.
 - Archery Range
 ...
 - Stable
   ...
   - Missing Paladin.
     ...
     - Gameplay considerations also played a role here - Paladins with Oprichina would be downright broken, but I didn't want to restrict its effect to just the Scout line.
 - Siege Workshop
   - Missing Siege Ram.
...
## Architecture: Eastern European
 ...
 - Castle Skin
   - [The Moscow Kremlin in the 14th century, by Apollinary Vasnetsov](https://rusmania.com/perch/resources/moscow-kalita-vasnetsov.jpg) - [Full article on 14th century Russia](https://rusmania.com/history-of-russia/14th-century)
   - It is clear that for most of the time scope of this build, the Muscovites would have used primarily wooden fortifications, which is also referenced in the Detinets bonus. While most of the cost of Castles remains stone for gameplay purposes, aesthetically the sprite should be largely wooden, though some creative liberties could be taken to make it look more like what an Age of Empires 2 player would expect a Castle to look like.
 - Wonder Skin:
   - [Cathedral of Saint Basil the Blessed](https://www.britannica.com/topic/Saint-Basil-the-Blessed) - [Image](https://cdn.britannica.com/48/5848-050-6292F88D/Cathedral-of-St-Basil-the-Blessed-Moscow.jpg)
   ...
   - Alternatively, if one wanted to focus on an older period of Muscovite history, [Dormition Cathedral](https://ageofempires.fandom.com/wiki/Dormition_Cathedral) is already in the game as a scenario editor building, so that sprite could be used.
...
## Sigil
 ...
 - Alternatively, it could be simplified even further to just depict a spear pointing downwards, with a Russian Orthodox Cross on top, like in [this instance of the aforementioned coat of arms](https://en.wikipedia.org/wiki/Coat_of_arms_of_Moscow#/media/File:Coat_of_arms_of_Moscow_Oblast_(large).svg).
...
## Jingle
 ...
 - I think [this](https://www.youtube.com/watch?v=jve6HqYHwaY&t=240s) (4:00-9:11, starting timestamp in link) is a much better example, with typically Russian characteristics, such as repeating phrases, vocal exclamations, whistling and flutes.
 - This would also make it very unique and distinctive among other AoE2 civilization jingles, since currently no others feature female vocals.
...
## Game Plan
 ...
 - Notably, making Scouts costs only food, so gathering from huntables with them is a good way to have a reasonable Castle Age time even while making Feudal military - something other civilizations typcially aren't able to do. The weakness here is that it is quite obvious, as its its counterplay - creating Spearmen to defend forward hunters - these Spearmen can in turn be countered by Men At Arms, for which the Muscovite player will have abundant resources.
 - Being greedy is not a valid option against Muscovites - they are able to play even greedier. You will have to invest in Feudal pressure if possible to prevent them from getting many Scouts out and taking all the free food off the map. Playing against them the name of the game is stalling for time, since their bonuses basically run dry and switch gears in the Castle Age.
 - As Castle Age rolls around, your early advantage will fizzle out, Light Cavalry is not as good at Castle Age raiding as Scouts are in Feudal, and Longswords are also not in the best place in the meta. At this point you can switch into Knights/Lancers, Strelets or even Crossbows if the situation calls for it. While you may not be getting more resources than another civilization anymore, you should have done some damage to the enemy, and you should be looking to secure it. Since you'll be on wood anyway, switching to stone to make a Castle is much faster and less disruptive, whether offensively or defensively. Use this to prop up your defences (especially with using less stone to repair) or consolidate your gains from Feudal. You can also push for more damage with Oprichina, but be careful not to overextend. Your Castles are generic in Castle Age, missing no techs, but your economy also has no bonuses.
 - By the late game, you have some notable gaps in your military tech tree, but are a rare civilization to have a full economy tech tree. Your powerful late game options include Cavaliers (or Boyars) and Lancers, Streltsy, Bombard Cannons, and maybe Heavy Cavalry Archers if you have secure access to gold. If not, your Swordsman line is fully upgraded, and Lancers can still work in a lower-gold situation, especially with Oprichina supercharging their raiding capabilities.
...
## Summary
 ...
 - The Muscovites feel like a civilization playing which you will never have a dull moment - raiding, securing the map, microing squishy Streltsy against Mangonels, and getting the most out of your Scouts from both a military and an economic viewpoint - all requires a lot of attention, but can also be rewarding, and I think this civ will have a decently high skill ceiling. 
 - Muscovites exhibit some similarities to the Mongols, with powerful early games due to hunt and scouting bonuses, and Cumans, with an obvious and strong game plan that the enemy needs to react to to avoid being at a disadvantage, both of which are fitting given their history. All three are also Lancer civilizations with strong Scout openings. They also have similarities to the Turks due to their significant reliance on gold units, though the Muscovite Pikeman and Skirmisher are nowhere near as weak as the Turkish.
 ...
 - The Muscovites' main weaknesses are that they are quite dependent on gold for many of their strongest options, including their primary ranged options - the Strelet, Heavy Cavalry Archer and Bombard Cannon. With no long-term eco bonus, you need to do damage to your enemy, so the pressure is on from the moment the game starts. 

## Considerations of changes to other Civilizations or the common Tech Tree

 - Since this build would only come about with a split of the Slavs civilization, the question arises about what to do with the Boyar. If, similarly to the Elephant Archer, it is turned into a regional unit for the East Slavic (and some other) civilizations, this one should naturally have it.
   - Given the focus on cavalry and the Oprichina unique tech, they would probably be among the best Boyars of any civ that would get them.
...
## Loose Threads
 ...
 - This is my first build with only 2 civ bonuses (though one does have two parts to it) - is this enough? They do have a broad tech tree and strong unique techs to compensate, and they don't seem like they would be particularly weak, but it also feels like one gameplay gimmick is doing most of the heavy lifting of making this viable, which is a recipe for something being either too weak or too strong. I don't think they'd feel generic - Persians didn't with only 2 bonuses for 20+ years, and these bonuses are significantly more noticeable - but I could be missing something obvious there as well.